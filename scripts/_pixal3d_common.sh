...
PIXAL3D_PID_FILE="${PIXAL3D_PID_FILE:-$PIXAL3D_LOG_DIR/pixal3d-runtime.pid}"
PIXAL3D_GRADIO_PID_FILE="${PIXAL3D_GRADIO_PID_FILE:-$PIXAL3D_PID_FILE}"
PIXAL3D_HOST="${PIXAL3D_HOST:-127.0.0.1}"
PIXAL3D_PORT="${PIXAL3D_PORT:-8097}"
PIXAL3D_GRADIO_HOST="${PIXAL3D_GRADIO_HOST:-$PIXAL3D_HOST}"
PIXAL3D_GRADIO_PORT="${PIXAL3D_GRADIO_PORT:-$PIXAL3D_PORT}"
...
export PIXAL3D_OUTPUT_DIR PIXAL3D_LOG_DIR PIXAL3D_CONFIG_DIR PIXAL3D_MODEL_REPO PIXAL3D_PROFILE PIXAL3D_LOW_VRAM PIXAL3D_RESOLUTION
...
pixal3d_gradio_is_running() {
  ...
  pixal3d_probe_url "${PIXAL3D_GRADIO_URL}" >/dev/null 2>&1 && return 0
  return 1
}
